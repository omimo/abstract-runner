...
Trex.prototype = {
    ...
    draw: function (x, y) {
        ...
        for (i=-4;i<20;i++) {
            ...
            this.canvasCtx.moveTo(0, getRandomNum(0,Runner.defaultDimensions.HEIGHT));
            
            // this.canvasCtx.moveTo(getRandomNum(0,Runner.defaultDimensions.WIDTH), Runner.defaultDimensions.HEIGHT);
            ...
            this.canvasCtx.lineTo(this.xPos + sourceWidth/2 + i*1,Runner.defaultDimensions.HEIGHT);
